package com.example.lky.mymediaplayer;
...
private Display currDisplay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (player.isPlaying()){
                    int currenPosition=player.getCurrentPosition();
                    if (currenPosition-10000>0){
                        player.seekTo(currenPosition-10000);
                    }
                }
            }
        });
        ff.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (player.isPlaying()){
                    int currenPosition=player.getCurrentPosition();
                    if (currenPosition+10000<player.getDuration()){
                        player.seekTo(currenPosition+10000);
                    }
                }
            }
